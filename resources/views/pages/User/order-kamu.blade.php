            ...
            <div class="icons border">
               <div class="flex">
                  <div class="inputBox">
                     ...
                     <input type="text" placeholder="Tuliskan Nama " name="name" value="<?php if(Auth::user()){ echo Auth::user()->name;} ?>" class="name" readonly />
                  </div>
                  <div class="inputBox">
                     <span>Nomor Pemesan</span>
                     <input type="text" placeholder="Tuliskan Nomor HP" value="<?php if(Auth::user()){ echo Auth::user()->name; } ?>" name="phone_number" class="name" required />
                  </div>
                  <div class="inputBox">
                     <span>Alamat Pemesan</span>
                     <input type="text" placeholder="Tuliskan Alamat" value="<?php if(Auth::user()){ echo Auth::user()->name; } ?>" name="phone_number" class="name" required />
                  </div>
               </div>
            </div>
