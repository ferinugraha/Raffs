...
<section class="about" id="about">
    ...
    <div class="content">
        ...
        <div class="icons-container">
            ...
            <div class="icons">
                <img src="{{ asset('assets/home/image/serv-4.png') }}" alt="" />
                <h3>24/7 support</h3>
            </div>
        </div>
    </div>
        ...
        @forelse ($menu as $item)
            ...
            <div class="box">
                ...
                <div class="content">
                    ...
                    {{-- <a href="/detail-list-produk/{{ $item->id }}" class="btn">Lihat Detail</a> --}}
                    <a href="/Detail-Produk/{{ $item->id }}" class="btn">Lihat Detail</a>
                </div>
            </div>
...
<section class="banner">
    <div class="row-banner">
        ...
        <div class="content">
            ...
            <p style="width:300px;">{{ $profile->description_big }}</p>
